...
using Osdu.Client.Data.Abstract;

namespace Osdu.Client.Data.MasterData;
...
public class BHARun_2_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0, AbstractProject_1_0_0
{
    ...
    public List<BHARun_2_1_0_FundsAuthorizations>? FundsAuthorizations { get; set; }
    ...
    public List<BHARun_2_1_0_Contractors>? Contractors { get; set; }
    ...
    public List<BHARun_2_1_0_Personnel>? Personnel { get; set; }
    ...
    public List<BHARun_2_1_0_ProjectSpecifications>? ProjectSpecifications { get; set; }

    /// <summary>
    /// The history of life cycle states that the Project has been through..
    /// </summary>
    [JsonPropertyName("ProjectStates")]
    public List<BHARun_2_1_0_ProjectStates>? ProjectStates { get; set; }
    ...
    public BHARun_2_1_0_FluidsProgramReference? FluidsProgramReference { get; set; }
    ...
    public List<BHARun_2_1_0_RunParameterPlans>? RunParameterPlans { get; set; }
    ...
    public List<BHARun_2_1_0_DrillingParams>? DrillingParams { get; set; }
...
/// The history of expenditure approvals.
/// </summary>
public class BHARun_2_1_0_FundsAuthorizations
{
    /// <summary>
...
/// References to organisations which supplied services to the Project.
/// </summary>
public class BHARun_2_1_0_Contractors
{
    /// <summary>
...
/// List of key individuals supporting the Project.  This could be Abstracted for re-use, and could reference a separate Persons master data object.
/// </summary>
public class BHARun_2_1_0_Personnel
{
    /// <summary>
...
/// General parameters defining the configuration of the Project.  In the case of a seismic acquisition project it is like receiver interval, source depth, source type.  In the case of a processing project, it is like replacement velocity, reference datum above mean sea level.
/// </summary>
public class BHARun_2_1_0_ProjectSpecifications
{
    /// <summary>
...
/// The history of life cycle states that the Project has been through..
/// </summary>
public class BHARun_2_1_0_ProjectStates
{
    /// <summary>
...
/// Used to reference the FluidsProgram object containing a list of fluid intervals for the Wellbore.
/// </summary>
public class BHARun_2_1_0_FluidsProgramReference
{
    /// <summary>
...
/// </summary>
public class BHARun_2_1_0_RunParameterPlans
{
    /// <summary>
    ...
    public BHARun_2_1_0_OperationParameterPlan? OperationParameterPlan { get; set; }
...
/// A series of operating parameters observed during the run
/// </summary>
public class BHARun_2_1_0_OperationParameterPlan
{
    /// <summary>
...
/// </summary>
public class BHARun_2_1_0_MaximumParameter
{
    /// <summary>
    ...
    public List<BHARun_2_1_0_PointsSources>? PointsSources { get; set; }
...
/// </summary>
public class BHARun_2_1_0_PointsSources
{
    /// <summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_MinimumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_MinimumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_MinimumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_RecommendedParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_RecommendedParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_RecommendedParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The planned surface rotary speed values for the BHA run.
/// </summary>
public class BHARun_2_1_0_SurfaceRPMGroup
{
    /// <summary>
    /// The planned maximum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MaximumParameter")]
    public List<BHARun_2_1_0_SurfaceRPMGroupMaximumParameter>? MaximumParameter { get; set; }

    /// <summary>
    /// The planned minimum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MinimumParameter")]
    public List<BHARun_2_1_0_SurfaceRPMGroupMinimumParameter>? MinimumParameter { get; set; }

    /// <summary>
    /// The planned recommended value for the considered parameter
    /// </summary>
    [JsonPropertyName("RecommendedParameter")]
    public List<BHARun_2_1_0_SurfaceRPMGroupRecommendedParameter>? RecommendedParameter { get; set; }
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_SurfaceRPMGroupMaximumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_SurfaceRPMGroupMaximumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_SurfaceRPMGroupMaximumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_SurfaceRPMGroupMinimumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_SurfaceRPMGroupMinimumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_SurfaceRPMGroupMinimumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_SurfaceRPMGroupRecommendedParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_SurfaceRPMGroupRecommendedParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_SurfaceRPMGroupRecommendedParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The planned downhole rotary speed values for the BHA run.
/// </summary>
public class BHARun_2_1_0_DownHoleRPMGroup
{
    /// <summary>
    /// The planned maximum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MaximumParameter")]
    public List<BHARun_2_1_0_DownHoleRPMGroupMaximumParameter>? MaximumParameter { get; set; }

    /// <summary>
    /// The planned minimum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MinimumParameter")]
    public List<BHARun_2_1_0_DownHoleRPMGroupMinimumParameter>? MinimumParameter { get; set; }

    /// <summary>
    /// The planned recommended value for the considered parameter
    /// </summary>
    [JsonPropertyName("RecommendedParameter")]
    public List<BHARun_2_1_0_DownHoleRPMGroupRecommendedParameter>? RecommendedParameter { get; set; }
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_DownHoleRPMGroupMaximumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_DownHoleRPMGroupMaximumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_DownHoleRPMGroupMaximumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_DownHoleRPMGroupMinimumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_DownHoleRPMGroupMinimumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_DownHoleRPMGroupMinimumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_DownHoleRPMGroupRecommendedParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_DownHoleRPMGroupRecommendedParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_DownHoleRPMGroupRecommendedParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// A group of parameters that refer to ROP (rate of penetration)
/// </summary>
public class BHARun_2_1_0_ROPGroup
{
    /// <summary>
    /// The planned maximum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MaximumParameter")]
    public List<BHARun_2_1_0_ROPGroupMaximumParameter>? MaximumParameter { get; set; }

    /// <summary>
    /// The planned minimum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MinimumParameter")]
    public List<BHARun_2_1_0_ROPGroupMinimumParameter>? MinimumParameter { get; set; }

    /// <summary>
    /// The planned recommended value for the considered parameter
    /// </summary>
    [JsonPropertyName("RecommendedParameter")]
    public List<BHARun_2_1_0_ROPGroupRecommendedParameter>? RecommendedParameter { get; set; }
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_ROPGroupMaximumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_ROPGroupMaximumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_ROPGroupMaximumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_ROPGroupMinimumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_ROPGroupMinimumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_ROPGroupMinimumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_ROPGroupRecommendedParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_ROPGroupRecommendedParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_ROPGroupRecommendedParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// A group of parameters that refer to WOB (weight on bit)
/// </summary>
public class BHARun_2_1_0_WOBGroup
{
    /// <summary>
    /// The planned maximum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MaximumParameter")]
    public List<BHARun_2_1_0_WOBGroupMaximumParameter>? MaximumParameter { get; set; }

    /// <summary>
    /// The planned minimum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MinimumParameter")]
    public List<BHARun_2_1_0_WOBGroupMinimumParameter>? MinimumParameter { get; set; }

    /// <summary>
    /// The planned recommended value for the considered parameter
    /// </summary>
    [JsonPropertyName("RecommendedParameter")]
    public List<BHARun_2_1_0_WOBGroupRecommendedParameter>? RecommendedParameter { get; set; }
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_WOBGroupMaximumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_WOBGroupMaximumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_WOBGroupMaximumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_WOBGroupMinimumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_WOBGroupMinimumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_WOBGroupMinimumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_WOBGroupRecommendedParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_WOBGroupRecommendedParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_WOBGroupRecommendedParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// A group of parameters that refer to flowrate
/// </summary>
public class BHARun_2_1_0_FlowratePumpGroup
{
    /// <summary>
    /// The planned maximum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MaximumParameter")]
    public List<BHARun_2_1_0_FlowratePumpGroupMaximumParameter>? MaximumParameter { get; set; }

    /// <summary>
    /// The planned minimum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MinimumParameter")]
    public List<BHARun_2_1_0_FlowratePumpGroupMinimumParameter>? MinimumParameter { get; set; }

    /// <summary>
    /// The planned recommended value for the considered parameter
    /// </summary>
    [JsonPropertyName("RecommendedParameter")]
    public List<BHARun_2_1_0_FlowratePumpGroupRecommendedParameter>? RecommendedParameter { get; set; }
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_FlowratePumpGroupMaximumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_FlowratePumpGroupMaximumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_FlowratePumpGroupMaximumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_FlowratePumpGroupMinimumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_FlowratePumpGroupMinimumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_FlowratePumpGroupMinimumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_FlowratePumpGroupRecommendedParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_FlowratePumpGroupRecommendedParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_FlowratePumpGroupRecommendedParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// A group of parameters that refer to anticipated Torque at Surface
/// </summary>
public class BHARun_2_1_0_TorqueAtSurfaceGroup
{
    /// <summary>
    /// The planned maximum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MaximumParameter")]
    public List<BHARun_2_1_0_TorqueAtSurfaceGroupMaximumParameter>? MaximumParameter { get; set; }

    /// <summary>
    /// The planned minimum value for the considered parameter
    /// </summary>
    [JsonPropertyName("MinimumParameter")]
    public List<BHARun_2_1_0_TorqueAtSurfaceGroupMinimumParameter>? MinimumParameter { get; set; }

    /// <summary>
    /// The planned recommended value for the considered parameter
    /// </summary>
    [JsonPropertyName("RecommendedParameter")]
    public List<BHARun_2_1_0_TorqueAtSurfaceGroupRecommendedParameter>? RecommendedParameter { get; set; }
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_TorqueAtSurfaceGroupMaximumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_TorqueAtSurfaceGroupMaximumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_TorqueAtSurfaceGroupMaximumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_TorqueAtSurfaceGroupMinimumParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_TorqueAtSurfaceGroupMinimumParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_TorqueAtSurfaceGroupMinimumParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// The definition of the point
/// </summary>
public class BHARun_2_1_0_TorqueAtSurfaceGroupRecommendedParameter
{
    /// <summary>
    /// The measured depth at which the measurement was observed. Depth relative to Planned wellbore ZDP. Navigate via WellboreID to the side-car WellPlanningWellbore, which holds the depth reference in data.VerticalMeasurement.
    /// </summary>
    ...
    /// </summary>
    [JsonPropertyName("PointsSources")]
    public List<BHARun_2_1_0_TorqueAtSurfaceGroupRecommendedParameterPointsSources>? PointsSources { get; set; }
...
/// The definition of the points used as a source for each individual critical point, resulting from parameters set or observed during a BHA run
/// </summary>
public class BHARun_2_1_0_TorqueAtSurfaceGroupRecommendedParameterPointsSources
{
    /// <summary>
    /// The name of the Source Indicator Type. For example Manual Input
    /// </summary>
...
/// </summary>
public class BHARun_2_1_0_DrillingParams
{
    /// <summary>
