...
public class Wellbore_1_5_1_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0, AbstractFacility_1_1_0
{
    ...
    public List<Wellbore_1_5_1_VerticalMeasurements>? VerticalMeasurements { get; set; }
    ...
    public List<Wellbore_1_5_1_HistoricalInterests>? HistoricalInterests { get; set; }
    ...
    public List<Wellbore_1_5_1_WellboreCosts>? WellboreCosts { get; set; }
...
public class Wellbore_1_5_1_VerticalMeasurements : AbstractFacilityVerticalMeasurement_1_0_0
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_5_1_HistoricalInterests
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_5_1_WellboreCosts
{
    /// <summary>
