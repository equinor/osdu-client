...
public class ConnectedSourceDataJob_1_8_0_Data : AbstractCommonResources_1_0_1 // Also composes: AbstractMaster_1_2_0, AbstractProject_1_0_0, AbstractProjectActivity_1_2_0
{
    ...
    public List<ConnectedSourceDataJob_1_8_0_FundsAuthorizations>? FundsAuthorizations { get; set; }
    ...
    public List<ConnectedSourceDataJob_1_8_0_Contractors>? Contractors { get; set; }
    ...
    public List<ConnectedSourceDataJob_1_8_0_Personnel>? Personnel { get; set; }
    ...
    public List<ConnectedSourceDataJob_1_8_0_ProjectSpecifications>? ProjectSpecifications { get; set; }

    /// <summary>
    /// The history of life cycle states that the Project has been through..
    /// </summary>
    [JsonPropertyName("ProjectStates")]
    public List<ConnectedSourceDataJob_1_8_0_ProjectStates>? ProjectStates { get; set; }
    ...
    public List<ConnectedSourceDataJob_1_8_0_Workflows>? Workflows { get; set; }
    ...
    public List<ConnectedSourceDataJob_1_8_0_ExternalProcesses>? ExternalProcesses { get; set; }
...
/// The history of expenditure approvals.
/// </summary>
public class ConnectedSourceDataJob_1_8_0_FundsAuthorizations
{
    /// <summary>
...
/// References to organisations which supplied services to the Project.
/// </summary>
public class ConnectedSourceDataJob_1_8_0_Contractors
{
    /// <summary>
...
/// List of key individuals supporting the Project.  This could be Abstracted for re-use, and could reference a separate Persons master data object.
/// </summary>
public class ConnectedSourceDataJob_1_8_0_Personnel
{
    /// <summary>
...
/// General parameters defining the configuration of the Project.  In the case of a seismic acquisition project it is like receiver interval, source depth, source type.  In the case of a processing project, it is like replacement velocity, reference datum above mean sea level.
/// </summary>
public class ConnectedSourceDataJob_1_8_0_ProjectSpecifications
{
    /// <summary>
...
/// The history of life cycle states that the Project has been through..
/// </summary>
public class ConnectedSourceDataJob_1_8_0_ProjectStates
{
    /// <summary>
...
/// </summary>
public class ConnectedSourceDataJob_1_8_0_Workflows
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("Parameters")]
    public List<ConnectedSourceDataJob_1_8_0_Parameters>? Parameters { get; set; }
...
/// </summary>
public class ConnectedSourceDataJob_1_8_0_Parameters
{
    /// <summary>
...
/// A workflow configuration in the context of a scheduled job.
/// </summary>
public class ConnectedSourceDataJob_1_8_0_ExternalProcesses
{
    /// <summary>
    ...
    public required string EdsExternalProcessTypeID { get; set; }
