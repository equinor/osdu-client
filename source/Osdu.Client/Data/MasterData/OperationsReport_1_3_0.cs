...
public class OperationsReport_1_3_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_1_0
{
    ...
    public List<OperationsReport_1_3_0_BitRecord>? BitRecord { get; set; }
    ...
    public List<OperationsReport_1_3_0_DrillActivity>? DrillActivity { get; set; }
    ...
    public List<OperationsReport_1_3_0_OperationsActivity>? OperationsActivity { get; set; }
    ...
    public OperationsReport_1_3_0_WellAlias? WellAlias { get; set; }

    /// <summary>
    /// Local name defined for the wellbore
    /// </summary>
    [JsonPropertyName("WellboreAlias")]
    public List<OperationsReport_1_3_0_WellboreAlias>? WellboreAlias { get; set; }

    /// <summary>
    /// Information regarding the status of the wellbore during this reporting period
    /// </summary>
    [JsonPropertyName("StatusInfo")]
    public List<OperationsReport_1_3_0_StatusInfo>? StatusInfo { get; set; }
    ...
    public List<OperationsReport_1_3_0_TimedComments>? TimedComments { get; set; }
    ...
    public List<OperationsReport_1_3_0_Weather>? Weather { get; set; }
    ...
    public List<OperationsReport_1_3_0_GasReading>? GasReading { get; set; }
...
/// </summary>
public class OperationsReport_1_3_0_BitRecord
{
    /// <summary>
...
/// </summary>
public class OperationsReport_1_3_0_DrillActivity
{
    /// <summary>
    ...
    public List<OperationsReport_1_3_0_ProprietaryActivityCode>? ProprietaryActivityCode { get; set; }
...
/// </summary>
public class OperationsReport_1_3_0_ProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class OperationsReport_1_3_0_OperationsActivity
{
    /// <summary>
    ...
    /// </summary>
    [JsonPropertyName("ProprietaryActivityCode")]
    public List<OperationsReport_1_3_0_OperationsActivityProprietaryActivityCode>? ProprietaryActivityCode { get; set; }
...
/// Definition of an alias
/// </summary>
public class OperationsReport_1_3_0_OperationsActivityProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Local name defined for the Well
/// </summary>
public class OperationsReport_1_3_0_WellAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Definition of an alias
/// </summary>
public class OperationsReport_1_3_0_WellboreAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class OperationsReport_1_3_0_StatusInfo
{
    /// <summary>
...
/// </summary>
public class OperationsReport_1_3_0_TimedComments
{
    /// <summary>
...
/// Meteorological readings for the defined time period on an operations report
/// </summary>
public class OperationsReport_1_3_0_Weather
{
    /// <summary>
...
/// Snapshot of operations personnel broken down by each company on the rig at the time of the report.
/// </summary>
public class OperationsReport_1_3_0_Personnel
{
    /// <summary>
...
/// Information related to pump operations on a drilling/operations report
/// </summary>
public class OperationsReport_1_3_0_PumpOp
{
    /// <summary>
...
/// Information related to mud volumes for drilling/operations report
/// </summary>
public class OperationsReport_1_3_0_MudVolume
{
    /// <summary>
...
/// Quantity of items inventoried during drilling and/or operations
/// </summary>
public class OperationsReport_1_3_0_Inventory
{
    /// <summary>
...
/// Cost information captured for a defined time period during operations and/or drilling
/// </summary>
public class OperationsReport_1_3_0_Cost
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Health Safety or Environment events that occurred since the last drilling/operation report. Captures data related to HSE events (e.g., tests, inspections, meetings, and drills), test values (e.g., pressure tested to), and/or incidents (e.g., discharges, non-compliance notices received, etc.).
/// </summary>
public class OperationsReport_1_3_0_HSE
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Description of incidents that have occurred during the last drilling/operations report
/// </summary>
public class OperationsReport_1_3_0_Incident
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Mud that has been lost during drilling / operations
/// </summary>
public class OperationsReport_1_3_0_MudLosses
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// General information about a gas reading taken during the drill report period
/// </summary>
public class OperationsReport_1_3_0_GasReading
{
    /// <summary>
