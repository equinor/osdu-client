...
public class ActivityPlan_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_1_0, AbstractProject_1_0_0
{
    ...
    public List<ActivityPlan_1_1_0_FundsAuthorizations>? FundsAuthorizations { get; set; }
    ...
    public List<ActivityPlan_1_1_0_Contractors>? Contractors { get; set; }
    ...
    public List<ActivityPlan_1_1_0_Personnel>? Personnel { get; set; }
    ...
    public List<ActivityPlan_1_1_0_ProjectSpecifications>? ProjectSpecifications { get; set; }

    /// <summary>
    /// The history of life cycle states that the Project has been through..
    /// </summary>
    [JsonPropertyName("ProjectStates")]
    public List<ActivityPlan_1_1_0_ProjectStates>? ProjectStates { get; set; }
    ...
    public List<ActivityPlan_1_1_0_WellPlanningActivities>? WellPlanningActivities { get; set; }
...
/// The history of expenditure approvals.
/// </summary>
public class ActivityPlan_1_1_0_FundsAuthorizations
{
    /// <summary>
...
/// References to organisations which supplied services to the Project.
/// </summary>
public class ActivityPlan_1_1_0_Contractors
{
    /// <summary>
...
/// List of key individuals supporting the Project.  This could be Abstracted for re-use, and could reference a separate Persons master data object.
/// </summary>
public class ActivityPlan_1_1_0_Personnel
{
    /// <summary>
...
/// General parameters defining the configuration of the Project.  In the case of a seismic acquisition project it is like receiver interval, source depth, source type.  In the case of a processing project, it is like replacement velocity, reference datum above mean sea level.
/// </summary>
public class ActivityPlan_1_1_0_ProjectSpecifications
{
    /// <summary>
...
/// The history of life cycle states that the Project has been through..
/// </summary>
public class ActivityPlan_1_1_0_ProjectStates
{
    /// <summary>
...
/// </summary>
public class ActivityPlan_1_1_0_WellPlanningActivities
{
    /// <summary>
    ...
    public ActivityPlan_1_1_0_DepthRange? DepthRange { get; set; }
    ...
    public List<ActivityPlan_1_1_0_ProductiveTimeStatistics>? ProductiveTimeStatistics { get; set; }

    /// <summary>
    /// Statistics that define the non productive time of this activity
    /// </summary>
    [JsonPropertyName("NonProductiveTimeStatistics")]
    public List<ActivityPlan_1_1_0_NonProductiveTimeStatistics>? NonProductiveTimeStatistics { get; set; }

    /// <summary>
    /// Statistics that define the rate of penetration of this activity
    /// </summary>
    [JsonPropertyName("RateOfPenetrationStatistics")]
    public List<ActivityPlan_1_1_0_RateOfPenetrationStatistics>? RateOfPenetrationStatistics { get; set; }
...
/// The depth range over which the the activity takes place
/// </summary>
public class ActivityPlan_1_1_0_DepthRange
{
    /// <summary>
...
/// </summary>
public class ActivityPlan_1_1_0_ProductiveTimeStatistics
{
    /// <summary>
...
/// Structure that describes a individual statistic record of the operations from an activity.
/// </summary>
public class ActivityPlan_1_1_0_NonProductiveTimeStatistics
{
    /// <summary>
    /// Record of the statistic estimation
    /// </summary>
...
/// </summary>
public class ActivityPlan_1_1_0_RateOfPenetrationStatistics
{
    /// <summary>
    /// Record of the statistic estimation
    /// </summary>
