...
public class Wellbore_1_5_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_2_0, AbstractFacility_1_1_0
{
    ...
    public List<Wellbore_1_5_0_VerticalMeasurements>? VerticalMeasurements { get; set; }
    ...
    public List<Wellbore_1_5_0_HistoricalInterests>? HistoricalInterests { get; set; }
    ...
    public List<Wellbore_1_5_0_WellboreCosts>? WellboreCosts { get; set; }
...
public class Wellbore_1_5_0_VerticalMeasurements : AbstractFacilityVerticalMeasurement_1_0_0
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_5_0_HistoricalInterests
{
    /// <summary>
...
/// </summary>
public class Wellbore_1_5_0_WellboreCosts
{
    /// <summary>
