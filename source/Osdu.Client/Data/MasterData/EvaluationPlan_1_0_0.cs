...
public class EvaluationPlan_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_0_0, AbstractProject_1_0_0
{
    ...
    public List<EvaluationPlan_1_0_0_FundsAuthorizations>? FundsAuthorizations { get; set; }
    ...
    public List<EvaluationPlan_1_0_0_Contractors>? Contractors { get; set; }
    ...
    public List<EvaluationPlan_1_0_0_Personnel>? Personnel { get; set; }
    ...
    public List<EvaluationPlan_1_0_0_ProjectSpecifications>? ProjectSpecifications { get; set; }

    /// <summary>
    /// The history of life cycle states that the Project has been through..
    /// </summary>
    [JsonPropertyName("ProjectStates")]
    public List<EvaluationPlan_1_0_0_ProjectStates>? ProjectStates { get; set; }

    /// <summary>
    /// A collection of integrity evaluations made on a formation
    /// </summary>
    [JsonPropertyName("FormationIntegrityEvaluations")]
    public List<EvaluationPlan_1_0_0_FormationIntegrityEvaluations>? FormationIntegrityEvaluations { get; set; }

    /// <summary>
    /// Information regarding any evaluation made on the formation by analyzing cores
    /// </summary>
    [JsonPropertyName("FormationEvaluationCorings")]
    public List<EvaluationPlan_1_0_0_FormationEvaluationCorings>? FormationEvaluationCorings { get; set; }

    /// <summary>
    /// Information regarding the evaluation of the reservoir
    /// </summary>
    [JsonPropertyName("ReservoirEvaluations")]
    public List<EvaluationPlan_1_0_0_ReservoirEvaluations>? ReservoirEvaluations { get; set; }
...
/// The history of expenditure approvals.
/// </summary>
public class EvaluationPlan_1_0_0_FundsAuthorizations
{
    /// <summary>
...
/// References to organisations which supplied services to the Project.
/// </summary>
public class EvaluationPlan_1_0_0_Contractors
{
    /// <summary>
...
/// List of key individuals supporting the Project.  This could be Abstracted for re-use, and could reference a separate Persons master data object.
/// </summary>
public class EvaluationPlan_1_0_0_Personnel
{
    /// <summary>
...
/// General parameters defining the configuration of the Project.  In the case of a seismic acquisition project it is like receiver interval, source depth, source type.  In the case of a processing project, it is like replacement velocity, reference datum above mean sea level.
/// </summary>
public class EvaluationPlan_1_0_0_ProjectSpecifications
{
    /// <summary>
...
/// The history of life cycle states that the Project has been through..
/// </summary>
public class EvaluationPlan_1_0_0_ProjectStates
{
    /// <summary>
...
/// </summary>
public class EvaluationPlan_1_0_0_FormationIntegrityEvaluations
{
    /// <summary>
...
/// </summary>
public class EvaluationPlan_1_0_0_FormationEvaluationCorings
{
    /// <summary>
...
/// </summary>
public class EvaluationPlan_1_0_0_ReservoirEvaluations
{
    /// <summary>
