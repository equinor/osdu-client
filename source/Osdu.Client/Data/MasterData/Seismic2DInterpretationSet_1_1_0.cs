...
public class Seismic2DInterpretationSet_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_0_0, AbstractProject_1_0_0, AbstractProjectActivity_1_0_0
{
    ...
    public List<Seismic2DInterpretationSet_1_1_0_FundsAuthorizations>? FundsAuthorizations { get; set; }
    ...
    public List<Seismic2DInterpretationSet_1_1_0_Contractors>? Contractors { get; set; }
    ...
    public List<Seismic2DInterpretationSet_1_1_0_Personnel>? Personnel { get; set; }
    ...
    public List<Seismic2DInterpretationSet_1_1_0_ProjectSpecifications>? ProjectSpecifications { get; set; }

    /// <summary>
    /// The history of life cycle states that the Project has been through..
    /// </summary>
    [JsonPropertyName("ProjectStates")]
    public List<Seismic2DInterpretationSet_1_1_0_ProjectStates>? ProjectStates { get; set; }
    ...
    public List<Seismic2DInterpretationSet_1_1_0_SeismicLineGeometries>? SeismicLineGeometries { get; set; }
...
/// The history of expenditure approvals.
/// </summary>
public class Seismic2DInterpretationSet_1_1_0_FundsAuthorizations
{
    /// <summary>
...
/// References to organisations which supplied services to the Project.
/// </summary>
public class Seismic2DInterpretationSet_1_1_0_Contractors
{
    /// <summary>
...
/// List of key individuals supporting the Project.  This could be Abstracted for re-use, and could reference a separate Persons master data object.
/// </summary>
public class Seismic2DInterpretationSet_1_1_0_Personnel
{
    /// <summary>
...
/// General parameters defining the configuration of the Project.  In the case of a seismic acquisition project it is like receiver interval, source depth, source type.  In the case of a processing project, it is like replacement velocity, reference datum above mean sea level.
/// </summary>
public class Seismic2DInterpretationSet_1_1_0_ProjectSpecifications
{
    /// <summary>
...
/// The history of life cycle states that the Project has been through..
/// </summary>
public class Seismic2DInterpretationSet_1_1_0_ProjectStates
{
    /// <summary>
...
/// </summary>
public class Seismic2DInterpretationSet_1_1_0_SeismicLineGeometries
{
    /// <summary>
