...
public class TubularComponent_2_4_0_Data : AbstractCommonResources_1_0_1 // Also composes: AbstractMaster_1_2_0
{
    ...
    public List<TubularComponent_2_4_0_Nozzles>? Nozzles { get; set; }

    /// <summary>
    /// Description of the type of Sensor(s) for the Tubular Components e.g. for MWD/LWD tools
    /// </summary>
    [JsonPropertyName("Sensors")]
    public List<TubularComponent_2_4_0_Sensors>? Sensors { get; set; }
...
/// </summary>
public class TubularComponent_2_4_0_Nozzles
{
    /// <summary>
    ...
    public required string NozzleID { get; set; }
    ...
    public required double DiameterInside { get; set; }
    ...
    public required string NozzleTypeID { get; set; }
    ...
    public required int NozzleCount { get; set; }
...
/// </summary>
public class TubularComponent_2_4_0_Sensors
{
    /// <summary>
    ...
    public required string SensorTypeID { get; set; }
