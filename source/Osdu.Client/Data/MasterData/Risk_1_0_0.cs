...
public class Risk_1_0_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractMaster_1_0_0
{
    ...
    public List<Risk_1_0_0_Preventions>? Preventions { get; set; }
    ...
    public List<Risk_1_0_0_Mitigations>? Mitigations { get; set; }
...
/// </summary>
public class Risk_1_0_0_Preventions
{
    /// <summary>
    ...
    public required List<AbstractContact_1_0_0> Responsibles { get; set; }
...
/// Describe a set of action to prevent for a risk or to mitigate its consequences
/// </summary>
public class Risk_1_0_0_Mitigations
{
    /// <summary>
    /// Name of the response
    /// </summary>
