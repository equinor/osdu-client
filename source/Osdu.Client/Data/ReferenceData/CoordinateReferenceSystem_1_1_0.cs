...
public class CoordinateReferenceSystem_1_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractReferenceType_1_0_0
{
    ...
    public CoordinateReferenceSystem_1_1_0_CoordinateReferenceSystemType? CoordinateReferenceSystemType { get; set; }
    ...
    public CoordinateReferenceSystem_1_1_0_HorizontalCRS? HorizontalCRS { get; set; }
...
public enum CoordinateReferenceSystem_1_1_0_CoordinateReferenceSystemType
{
...
/// The horizontal CRS reference of a CompoundCRS. Only populated for CoordinateReferenceSystemType==CompoundCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_HorizontalCRS
{
    /// <summary>
    /// The HorizontalCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_AuthorityCode? AuthorityCode { get; set; }
...
/// The HorizontalCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_AuthorityCode
{
    /// <summary>
...
/// The vertical CRS reference of a CompoundCRS. Only populated for CoordinateReferenceSystemType==CompoundCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_VerticalCRS
{
    /// <summary>
    /// The VerticalCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_VerticalCRSAuthorityCode? AuthorityCode { get; set; }
...
/// The VerticalCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_VerticalCRSAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The Transformation bound to the BaseCRS in a BoundCRS. Only populated for CoordinateReferenceSystemType==BoundCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_Transformation
{
    /// <summary>
    /// The Transformation authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_TransformationAuthorityCode? AuthorityCode { get; set; }
...
/// The Transformation authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_TransformationAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The datum of this CRS. Only populated for CoordinateReferenceSystemType in [GeographicCRS, VerticalCRS, EngineeringCRS].
/// </summary>
public class CoordinateReferenceSystem_1_1_0_Datum
{
    /// <summary>
    /// The Datum authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_DatumAuthorityCode? AuthorityCode { get; set; }
...
/// The Datum authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_DatumAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The DatumEnsemble for the CRS's datum. Only populated for GeographicCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_DatumEnsemble
{
    /// <summary>
    /// The DatumEnsemble authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_DatumEnsembleAuthorityCode? AuthorityCode { get; set; }
...
/// The DatumEnsemble authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_DatumEnsembleAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The projection operation of a ProjectedCRS. Only populated for CoordinateReferenceSystemType==ProjectedCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_Projection
{
    /// <summary>
    /// The Projection Operation authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_ProjectionAuthorityCode? AuthorityCode { get; set; }
...
/// The Projection Operation authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_ProjectionAuthorityCode
{
    /// <summary>
...
/// The base geographic CRS of this projected CRS. Only populated for CoordinateReferenceSystemType==ProjectedCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_BaseCRS
{
    /// <summary>
    /// The BaseCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_BaseCRSAuthorityCode? AuthorityCode { get; set; }
...
/// The BaseCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_BaseCRSAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The source CRS of a BoundCRS. Only populated for CoordinateReferenceSystemType==BoundCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_SourceCRS
{
    /// <summary>
    /// The SourceCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_SourceCRSAuthorityCode? AuthorityCode { get; set; }
...
/// The SourceCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_SourceCRSAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The target CRS of this bound CRS. Only populated for CoordinateReferenceSystemType==BoundCRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_TargetCRS
{
    /// <summary>
    /// The TargetCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_TargetCRSAuthorityCode? AuthorityCode { get; set; }
...
/// The TargetCRS authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_TargetCRSAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Scope and extent information about the described CRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_Usages
{
    /// <summary>
    /// The Usage authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_UsagesAuthorityCode? AuthorityCode { get; set; }
    ...
    public CoordinateReferenceSystem_1_1_0_Extent? Extent { get; set; }

    /// <summary>
    /// Scope declaration.
    /// </summary>
    [JsonPropertyName("Scope")]
    public CoordinateReferenceSystem_1_1_0_Scope? Scope { get; set; }
...
/// The Usage authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_UsagesAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Extent or area of use information.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_Extent
{
    /// <summary>
    /// The Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_ExtentAuthorityCode? AuthorityCode { get; set; }
...
/// The Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_ExtentAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Scope declaration.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_Scope
{
    /// <summary>
    /// The Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_ScopeAuthorityCode? AuthorityCode { get; set; }
...
/// The Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_ScopeAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// The coordinate system defining the dimension and individual axes used by the CRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_CoordinateSystem
{
    /// <summary>
    /// The CoordinateSystem authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_CoordinateSystemAuthorityCode? AuthorityCode { get; set; }
...
/// The CoordinateSystem authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_CoordinateSystemAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Scope and extent information about the described CRS.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_PreferredUsage
{
    /// <summary>
    /// The PreferredUsage authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_PreferredUsageAuthorityCode? AuthorityCode { get; set; }
    ...
    /// </summary>
    [JsonPropertyName("Extent")]
    public CoordinateReferenceSystem_1_1_0_PreferredUsageExtent? Extent { get; set; }

    /// <summary>
    /// Scope declaration.
    /// </summary>
    [JsonPropertyName("Scope")]
    public CoordinateReferenceSystem_1_1_0_PreferredUsageScope? Scope { get; set; }
...
/// The PreferredUsage authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_PreferredUsageAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Extent or area of use information.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_PreferredUsageExtent
{
    /// <summary>
    /// The Preferred Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_PreferredUsageExtentAuthorityCode? AuthorityCode { get; set; }
...
/// The Preferred Extent authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_PreferredUsageExtentAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
...
/// Scope declaration.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_PreferredUsageScope
{
    /// <summary>
    /// The Preferred Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
    /// </summary>
    [JsonPropertyName("AuthorityCode")]
    public CoordinateReferenceSystem_1_1_0_PreferredUsageScopeAuthorityCode? AuthorityCode { get; set; }
...
/// The Preferred Scope authority code, corresponding to the ISO19111 ID and 'projjson' id.
/// </summary>
public class CoordinateReferenceSystem_1_1_0_PreferredUsageScopeAuthorityCode
{
    /// <summary>
    /// The authority governing the 'Code'.
    /// </summary>
