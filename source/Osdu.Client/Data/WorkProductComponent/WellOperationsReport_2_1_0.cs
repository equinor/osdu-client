...
namespace Osdu.Client.Data.WorkProductComponent;
...
public class WellOperationsReport_2_1_0_Data : AbstractCommonResources_1_0_0 // Also composes: AbstractWPCGroupType_1_2_0, AbstractWorkProductComponent_1_1_0
{
    ...
    public List<WellOperationsReport_2_1_0_Artefacts>? Artefacts { get; set; }
    ...
    public List<WellOperationsReport_2_1_0_LineageAssertions>? LineageAssertions { get; set; }
    ...
    public List<WellOperationsReport_2_1_0_BitRecord>? BitRecord { get; set; }
    ...
    public List<WellOperationsReport_2_1_0_OperationsActivity>? OperationsActivity { get; set; }

    /// <summary>
    /// Local name defined for the Well
    /// </summary>
    [JsonPropertyName("WellAlias")]
    public WellOperationsReport_2_1_0_WellAlias? WellAlias { get; set; }

    /// <summary>
    /// Local name defined for the wellbore
    /// </summary>
    [JsonPropertyName("WellboreAlias")]
    public List<WellOperationsReport_2_1_0_WellboreAlias>? WellboreAlias { get; set; }

    /// <summary>
    /// Information regarding the status of the wellbore during this reporting period
    /// </summary>
    [JsonPropertyName("StatusInfo")]
    public List<WellOperationsReport_2_1_0_StatusInfo>? StatusInfo { get; set; }
    ...
    public List<WellOperationsReport_2_1_0_TimedComments>? TimedComments { get; set; }

    /// <summary>
    /// Meteorological readings for the defined time period on an operations report
    /// </summary>
    [JsonPropertyName("Weather")]
    public List<WellOperationsReport_2_1_0_Weather>? Weather { get; set; }
    ...
    public List<WellOperationsReport_2_1_0_GasReading>? GasReading { get; set; }
...
/// An array of Artefacts - each artefact has a Role, Resource tuple. An artefact is distinct from the file, in the sense certain valuable information is generated during loading process (Artefact generation process). Examples include retrieving location data, performing an OCR which may result in the generation of artefacts which need to be preserved distinctly
/// </summary>
public class WellOperationsReport_2_1_0_Artefacts
{
    /// <summary>
...
/// Defines relationships with other objects (any kind of Resource) upon which this work product component depends.  The assertion is directed only from the asserting WPC to ancestor objects, not children.  It should not be used to refer to files or artefacts within the WPC -- the association within the WPC is sufficient and Artefacts are actually children of the main WPC file. They should be recorded in the data.Artefacts[] array.
/// </summary>
public class WellOperationsReport_2_1_0_LineageAssertions
{
    /// <summary>
...
/// </summary>
public class WellOperationsReport_2_1_0_BitRecord
{
    /// <summary>
...
/// </summary>
public class WellOperationsReport_2_1_0_OperationsActivity
{
    /// <summary>
    ...
    public List<WellOperationsReport_2_1_0_ProprietaryActivityCode>? ProprietaryActivityCode { get; set; }
...
/// </summary>
public class WellOperationsReport_2_1_0_ProprietaryActivityCode
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// Local name defined for the Well
/// </summary>
public class WellOperationsReport_2_1_0_WellAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class WellOperationsReport_2_1_0_WellboreAlias
{
    /// <summary>
    /// Identifier property
    /// </summary>
...
/// </summary>
public class WellOperationsReport_2_1_0_StatusInfo
{
    /// <summary>
...
/// </summary>
public class WellOperationsReport_2_1_0_TimedComments
{
    /// <summary>
...
/// Meteorological readings for the defined time period on an operations report
/// </summary>
public class WellOperationsReport_2_1_0_Weather
{
    /// <summary>
...
/// Snapshot of operations personnel broken down by each company on the rig at the time of the report.
/// </summary>
public class WellOperationsReport_2_1_0_Personnel
{
    /// <summary>
...
/// Information related to pump operations on a drilling/operations report
/// </summary>
public class WellOperationsReport_2_1_0_PumpOp
{
    /// <summary>
...
/// Information related to mud volumes for drilling/operations report
/// </summary>
public class WellOperationsReport_2_1_0_MudVolume
{
    /// <summary>
...
/// Quantity of items inventoried during drilling and/or operations
/// </summary>
public class WellOperationsReport_2_1_0_Inventory
{
    /// <summary>
...
/// Cost information captured for a defined time period during operations and/or drilling
/// </summary>
public class WellOperationsReport_2_1_0_Cost
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Health Safety or Environment events that occurred since the last drilling/operation report. Captures data related to HSE events (e.g., tests, inspections, meetings, and drills), test values (e.g., pressure tested to), and/or incidents (e.g., discharges, non-compliance notices received, etc.).
/// </summary>
public class WellOperationsReport_2_1_0_HSE
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Description of incidents that have occurred during the last drilling/operations report
/// </summary>
public class WellOperationsReport_2_1_0_Incident
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// Mud that has been lost during drilling / operations
/// </summary>
public class WellOperationsReport_2_1_0_MudLosses
{
    /// <summary>
    /// Comments and remarks
    /// </summary>
...
/// General information about a gas reading taken during the drill report period
/// </summary>
public class WellOperationsReport_2_1_0_GasReading
{
    /// <summary>
