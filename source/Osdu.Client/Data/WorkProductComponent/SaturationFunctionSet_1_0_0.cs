...
public class SaturationFunctionSet_1_0_0_SaturationFunctions
{
    ...
    public required string FunctionUsageTypeID { get; set; }
    ...
    [JsonConverter(typeof(BooleanConverter))]
    public required bool HasRelativePermeability { get; set; }
    ...
    [JsonConverter(typeof(BooleanConverter))]
    public required bool HasCapillaryPressure { get; set; }
